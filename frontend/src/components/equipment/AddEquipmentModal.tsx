...
export default function AddEquipmentModal({
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    const operatingHours = Number(form.operatingHours || 0);
    const utilisation = Number(form.utilisation || 0);
    ...
    const record: EquipmentRecord = {
      ...
      name: form.name.trim(),
      type: form.type,
      manufacturer: form.manufacturer.trim() || "Not specified",
      model: form.model.trim() || "Not specified",
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-100 bg-white px-5 py-5 sm:px-7">
          <div className="flex items-center gap-3">
            <div className="rounded-xl bg-[#d8a83e]/15 p-2.5">
              <Plus size={20} className="text-[#d8a83e]" />
            </div>
          ...
          <div className="space-y-7">
            ...
            <section>
              <div className="mb-4 flex items-center gap-2">
                <Factory size={17} className="text-[#d8a83e]" />
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      updateField("equipmentId", event.target.value)
                    }
            ...
            <section>
              <div className="mb-4 flex items-center gap-2">
                <Gauge size={17} className="text-[#d8a83e]" />
                <h3 className="font-bold text-[#10251f]">
                  Operational Details
                </h3>
              </div>
            ...
            <section>
              <div className="mb-4 flex items-center gap-2">
                <CalendarDays size={17} className="text-[#d8a83e]" />
                <h3 className="font-bold text-[#10251f]">
                  Maintenance
                </h3>
              </div>
